-- CreateEnum
CREATE TYPE "Role" AS ENUM ('ADMIN', 'PROJECT_MANAGER', 'LEAD', 'DEVELOPER', 'TESTER');
...
-- CreateEnum
CREATE TYPE "ExpenseCategory" AS ENUM ('OFFICE', 'SOFTWARE', 'TRAVEL', 'SALARY', 'MARKETING', 'UTILITIES', 'OTHER');
...
-- CreateIndex
CREATE INDEX "task_assignment_logs_taskId_idx" ON "task_assignment_logs"("taskId");
...
-- CreateIndex
CREATE UNIQUE INDEX "monthly_summaries_userId_year_month_key" ON "monthly_summaries"("userId", "year", "month");
...
-- AddForeignKey
ALTER TABLE "task_assignment_logs" ADD CONSTRAINT "task_assignment_logs_taskId_fkey" FOREIGN KEY ("taskId") REFERENCES "tasks"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "task_assignment_logs" ADD CONSTRAINT "task_assignment_logs_assignedById_fkey" FOREIGN KEY ("assignedById") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "task_assignment_logs" ADD CONSTRAINT "task_assignment_logs_assignedToId_fkey" FOREIGN KEY ("assignedToId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "monthly_summaries" ADD CONSTRAINT "monthly_summaries_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
